...
export default function WhyFHB() {
  return (
    <section className="bg-navy-50/60 py-20 sm:py-24" aria-labelledby="why-fhb-heading">
      <div className="container-fhb">
        ...
        <Link
          href="/about"
          className="mt-8 inline-flex items-center gap-1.5 text-sm font-semibold text-teal-700 hover:text-teal-800"
        >
