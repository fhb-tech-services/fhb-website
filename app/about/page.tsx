    ...
    <>
      <section className="border-b border-navy-100 bg-navy-50/60 py-20 sm:py-24">
        <div className="container-fhb">
          <span className="inline-flex items-center gap-2 rounded-full bg-white px-3 py-1 text-xs font-semibold text-teal-700 shadow-sm">
            <MapPin className="h-3.5 w-3.5" aria-hidden="true" />
            About FHB Tech Services Inc.
          </span>
          <h1 className="mt-6 max-w-3xl text-balance text-4xl font-bold tracking-tight text-navy-950 sm:text-5xl">
      ...
      {/* Values */}
      <section className="bg-navy-50/60 py-20 sm:py-24" aria-labelledby="values-heading">
        <div className="container-fhb">
          <SectionHeading
            id="values-heading"
            eyebrow="Our Values"
            ...
            <div className="mx-auto mt-12 grid max-w-4xl gap-5 sm:grid-cols-2">
              {values.map((value) => {
                ...
                return (
                  <div
                    key={value.title}
                    className="flex h-full flex-col gap-3 rounded-2xl border border-navy-100 bg-white p-6 shadow-[var(--shadow-card)]"
                  >
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-teal-50 text-teal-700">
                      <Icon className="h-5 w-5" aria-hidden="true" />
                    </div>
                    <h3 className="text-base font-semibold text-navy-950">{value.title}</h3>
      ...
      <section className="py-20 sm:py-24">
        <div className="container-fhb">
          <div className="mx-auto max-w-3xl rounded-2xl border border-navy-100 bg-white p-8 text-center shadow-[var(--shadow-card)] sm:p-12">
            <MapPin className="mx-auto h-8 w-8 text-teal-700" aria-hidden="true" />
            <h2 className="mt-4 text-2xl font-bold tracking-tight text-navy-950">
